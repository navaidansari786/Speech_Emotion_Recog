...
Web-application based on ML model for recognition of emotion for selected audio file. You can try it on [streamlit sharing platform](https://share.streamlit.io/navaidansari786/speech_emotion_recog/main/app.py)
![img](images/emotion3.jpg)
...
You can try the app [here](https://share.streamlit.io/navaidansari786/speech_emotion_recog/main/app.py)
![Alt Text](demo2.gif)


## Team
Mohd. Navaid Ansari | Mohammad Anas Ansari
